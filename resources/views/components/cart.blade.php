    ...
    <section class="cart-block">
        ...
        <div class="cart__inner">
                        ...
                        <div class="cart__card">
                            ...
                            <div class="cart__card__info">
                                ...
                                <div class="product__cost">
                                    <span>{{ $cart_product->price }} гр.</span>
                                </div>
                                <div class="cart__card__footer">
                                    <div class="product__value">
                                        <a class="product__value__minus quantity-btn" data-action="decrease" data-content="{{ $cart_product->id }}">–</a>
                                        <div class="product__value__number">{{ $cart_product->quantity }}</div>
                                        <a class="product__value__plus quantity-btn" data-action="increase" data-content="{{ $cart_product->id }}">+</a>
                                    </div>
                                    <a href="#" data-id="{{ $cart_product->id }}" class="cart__card__trash" id="btn-cart-remove">
            ...
            <div class="cart__totalprice">
                <h4>Всего: <span class="get_total">{{ Cart::getTotal() }} грн.</span></h4>
            </div>
